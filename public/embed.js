(function () {
  ...
  function createEmbed() {
    ...
    shadowRoot.innerHTML = [
      ...
      ".ck-header { display: flex; align-items: center; justify-content: space-between; gap: 12px; min-height: 62px; padding: 14px 16px; background: linear-gradient(180deg, #C2D500, #C2D500); color: #111827; }",
